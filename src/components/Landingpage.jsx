  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f1923', color: 'white', fontFamily: '-apple-system, BlinkMacSystemFont, Segoe UI, sans-serif' }}>
      ...
      <nav style={{
        ...
        padding: '20px 40px', borderBottom: '1px solid #1e2d3d',
        position: 'sticky', top: 0, background: '#0f1923', zIndex: 100,
      }}>
      ...
      <div style={{
        ...
        <div style={{
          display: 'inline-block', background: '#1e2d3d',
          border: '1px solid #1D9E75', borderRadius: '20px',
          padding: '6px 16px', fontSize: '12px', color: '#1D9E75',
        ...
        <h1 style={{
          ...
          background: 'linear-gradient(135deg, #ffffff 0%, #a0aab4 100%)',
          WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
        }}>
          Turn your data into<br />beautiful reports
        </h1>

        <p style={{
          fontSize: '18px', color: '#6b7a8d', lineHeight: '1.7',
          marginBottom: '36px', maxWidth: '520px', margin: '0 auto 36px',
        }}>
          Upload a CSV or Excel file and get instant charts, AI-powered insights, and a professional PDF report in seconds.
        </p>
      ...
      <div style={{
        ...
        {[
          { icon: '📁', title: 'CSV & Excel Upload', desc: 'Drag and drop any CSV or Excel file. We handle the parsing automatically.' },
          ...
          <div key={i} style={{
            background: '#131f2e', border: '1px solid #1e2d3d',
            borderRadius: '12px', padding: '24px',
          }}>
            <div style={{
              width: '44px', height: '44px', background: '#1e2d3d',
      ...
      {/* How it works */}
      <div style={{
        background: '#131f2e', borderTop: '1px solid #1e2d3d',
        borderBottom: '1px solid #1e2d3d', padding: '60px 20px',
      }}>
        <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontSize: '28px', fontWeight: '800', marginBottom: '8px' }}>
            How it works
          </h2>
          <p style={{ color: '#6b7a8d', marginBottom: '48px', fontSize: '15px' }}>
            From raw data to professional report in 3 steps
          </p>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{ textAlign: 'center' }}>
                <div style={{
                  fontSize: '11px', color: '#1D9E75', fontWeight: '700',
      ...
      <div style={{
        ...
        <p style={{ color: '#6b7a8d', marginBottom: '28px', fontSize: '15px' }}>
          No account needed. Just upload your file and go.
        </p>
        <button onClick={onGetStarted} style={{
          background: '#1D9E75', color: 'white', border: 'none',
      ...
      {/* Footer */}
      <div style={{
        borderTop: '1px solid #1e2d3d', padding: '24px 40px',
        ...
        <p style={{ fontSize: '12px', color: '#4a5568' }}>
          Built with React, Node.js, and Groq AI
        </p>
      </div>
